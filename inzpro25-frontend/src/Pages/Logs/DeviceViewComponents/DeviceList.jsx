...
function DeviceList() {
  ...
  const getDeviceListOrderedByNameAndSerialNumber = async (name) => {
    const token = await getAccessTokenSilently();
    fetch(
      `${URL}api/devices?serialNumber=${serialNumber}&page=${currentPage}&size=5&sortBy=${sortBy}&order=${order}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    <>
      <div className="orderAddDeleteContainer">
        <div className="orderContainer">
          ...
          <div className="sortLabel sortLabelMarginLeft">Sort By</div>
        ...
        <div className="deleteAddContainer">
          <AddDevice setUpdateDeviceList={setUpdateDeviceList} />
